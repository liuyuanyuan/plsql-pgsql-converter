...
public class CliOptions {
	private final static Logger logger = LoggerFactory.getLogger(CliOptions.class);
	...
	public static CliOptions parseCliOptions(String[] args) throws Exception {
		...
		while (i < args.length) {
			...
			default: logger.error("Unrecognized option: %s\n", arg);throw new Exception("Unrecognized option: " + arg);//System.exit(1);break;
			}
		}
		return result;
	}
